  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Coming Soon <br />
        <span className="text-sky-300">The Ultimate Moving Company Software</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        Get ready to streamline your moving business with Juggernaut 360! This powerful, intuitive software lets you manage operations anytime, anywhere, with just a few clicks.
      </p>
      <SignUpForm />
    </>
  )
